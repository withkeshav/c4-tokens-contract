...
/// @title c4 GBP — Educational Test Token on BNB Chain
/// @notice ERC-20 test token for C4 Academy crypto-forensics training.
/// @dev Deployed on BNB Chain mainnet. Mintable by owner only. NOT a real asset.
contract C4_GBP is ERC20, ERC20Burnable, Ownable {
