...
/// @title c4 SGD — Educational Test Token on Optimism
/// @notice ERC-20 test token for C4 Academy crypto-forensics training.
/// @dev Deployed on Optimism mainnet. Mintable by owner only. NOT a real asset.
contract C4_SGD is ERC20, ERC20Burnable, Ownable {
